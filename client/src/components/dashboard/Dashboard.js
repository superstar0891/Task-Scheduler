...
import { SampleBase } from './sambase';
...
class Dashboard extends SampleBase {
  ...
  constructor() {
    ...
    this.contextMenuItems = [
      { text: 'New Task', iconCss: 'e-icons e-plus', id: 'Add' },
      { text: 'New Recurring Task', iconCss: 'e-icons e-repeat', id: 'AddRecurrence' },
      { text: 'Today', iconCss: 'e-icons e-timeline-today', id: 'Today' },
      { text: 'Edit Task', iconCss: 'e-icons e-edit', id: 'Save' },
      { text: 'Delete Task', iconCss: 'e-icons e-trash', id: 'Delete' },
      {
        text: 'Delete Task', id: 'DeleteRecurrenceEvent', iconCss: 'e-icons e-trash',
        items: [
      ...
      {
        text: 'Edit Task', id: 'EditRecurrenceEvent', iconCss: 'e-icons e-edit',
        items: [
              ...
              <div className='overview-header'>
                <div className='overview-titlebar'>
                  <div className='left-panel'>
                    <div className='schedule-overview-title animation1'>Welcome to Task Scheduler</div>
                  </div>
                  ...
                  <div className='right-panel'>
                    ...
                    <div className='control-panel calendar-export'>
                      <UploaderComponent id='fileUpload' type='file' allowedExtensions='.ics' cssClass='calendar-import' buttons={{ browse: this.importTemplateFn({ text: 'Import' })[0] }} multiple={false} showFileList={false} selected={(this.onImportClick.bind(this))} style={{ marginTop: '-6px' }} />
                    </div>
                    <div className='control-panel calendar-export'>
                      <DropDownButtonComponent id='exporting' iconCss='e-icons e-export'content='Export' items={this.exportItems} select={this.onExportClick.bind(this)} />
                    </div>

                    <div className='control-panel calendar-export'>
                   
                      <ButtonComponent  cssClass='title-bar-btn' iconCss="e-icons e-people" content={user.name.split(" ")[0]}/>
                    </div>
                    <div className='control-panel calendar-export'>
                    
                      <ButtonComponent id='logoutBtn' cssClass='title-bar-btn' iconCss="e-icons e-circle-close" onClick={this.onLogoutClick} content='Log out' />
                    </div>
              ...
              <div className='overview-toolbar'>
                <div style={{ height: '70px', width: 'calc(100% - 90px)' }}>
                  <ToolbarComponent id='toolbar_options' width='100%' height={70} overflowMode='Scrollable' scrollStep={100} created={() => setInterval(() => { this.updateLiveTime(); }, 1000)} clicked={this.onToolbarItemClicked.bind(this)}>
                    ...
                    <ItemsDirective>
                      <ItemDirective prefixIcon='e-icons e-plus' tooltipText='New Task' text='New Task' />
                      <ItemDirective prefixIcon='e-icons e-repeat' tooltipText='New Recurring Task' text='New Recurring Task' />
                  ...
                  <div className='control-panel e-css'>
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>First Day of Week</label>
                      </div>
                    ...
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>Work week</label>
                      </div>
                      <div className='col-right'>
                    ...
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>Resources</label>
                      </div>
                      <div className='col-right'>
                    ...
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>Timezone</label>
                      </div>
                      <div className='col-right'>
                    ...
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>Day Start Hour</label>
                      </div>
                      <div className='col-right'>
                    ...
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>Day End Hour</label>
                      </div>
                      <div className='col-right'>
                    ...
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>Work Start Hour</label>
                      </div>
                      <div className='col-right'>
                    ...
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>Work End Hour</label>
                      </div>
                      <div className='col-right'>
                    ...
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>Slot Duration</label>
                      </div>
                      <div className='col-right'>
                    ...
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>Slot Interval</label>
                      </div>
                      <div className='col-right'>
                    ...
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>Time Format</label>
                      </div>
                      <div className='col-right'>
                    ...
                    <div className='col-row'>
                      <div className='col-left'>
                        <label style={{ lineHeight: '34px', margin: '0',fontSize:'1.5rem' }}>Week Numbers</label>
                      </div>
                      <div className='col-right'>
